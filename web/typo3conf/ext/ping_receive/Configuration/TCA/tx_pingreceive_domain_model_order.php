...
return [
    'ctrl' => [
        ...
        'searchFields' => 'id,description,address,contact,customer,dishes',
        'iconfile' => 'EXT:ping_receive/Resources/Public/Icons/tx_pingreceive_domain_model_order.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, id, description, address, contact, customer, dishes',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, id, description, address, contact, customer, dishes, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'customer' => [
            'exclude' => false,
            'label' => 'LLL:EXT:ping_receive/Resources/Private/Language/locallang_db.xlf:tx_pingreceive_domain_model_order.customer',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
