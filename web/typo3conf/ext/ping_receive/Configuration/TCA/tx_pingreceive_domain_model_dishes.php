...
return [
    'ctrl' => [
        ...
        'searchFields' => 'id,type,quantity',
        'iconfile' => 'EXT:ping_receive/Resources/Public/Icons/tx_pingreceive_domain_model_dishes.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, id, type, quantity',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, id, type, quantity, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
